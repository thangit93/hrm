...
class EmployeeLeaveAdapter extends AdapterBase {
    ...
    getActionButtonsHtml(id, data) {
        ...
        html = '<div style="width:80px;">' +
            ...
            'rel="tooltip" title="Show Leave Days" onclick="modJs.getLeaveDaysReadonly(_id_);return false;">' +
            '</img><img class="tableActionButton" src="_BASE_images/run.png" style="cursor:pointer;margin-left:15px;" ' +
            'rel="tooltip" title="Change Leave Status" onclick="modJs.openLeaveStatus(_id_,\'_status_\');return false;"></img>' +
            '<img class="tableActionButton" src="_BASE_images/delete.png" style="margin-left:15px;cursor:pointer;" ' +
            'rel="tooltip" title="Cancel Leave" onclick="modJs.deleteRow(_id_);return false;"></img>' +
            '</div>';
